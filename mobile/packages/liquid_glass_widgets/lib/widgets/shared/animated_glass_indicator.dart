...
class AnimatedGlassIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Drop the solid pill before the glass lens ramps — otherwise it sits under
    // the icons and reads as a dark fill during the morph.
    final bool localRefraction = backgroundKey != null;
    final backgroundOpacity = localRefraction
        ? (thickness < 0.05
            ? 1.0
            : (1.0 - ((thickness - 0.05) / 0.18).clamp(0.0, 1.0)))
        : (1.0 - (thickness / 0.55)).clamp(0.0, 1.0);
    ...
    final glassWidget = GlassEffect(
      ...
      ambientRim: backgroundKey != null ? 0.18 : 0.1,
      baseAlphaMultiplier: backgroundKey != null ? 0.08 : 0.2,
      edgeAlphaMultiplier: backgroundKey != null ? 0.18 : 0.4,
