...
class SearchableTabIndicatorState extends State<SearchableTabIndicator>
  ...
  /// Captures tab icons for the sliding lens shader (not [GlassBackdropScope]).
  final GlobalKey _iconLayerKey = GlobalKey();

  GlobalKey get _indicatorRefractionKey =>
      widget.backgroundKey ?? _iconLayerKey;
          ...
          child: GestureDetector(
            ...
            child: VelocitySpringBuilder(
              ...
              builder: (context, value, velocity, child) {
                ...
                final alignmentDelta = (value - targetAlignment).abs();
                // Thickness tracks pill motion: resting tint at 0, full lens
                // while dragging or springing to a new tab after tap.
                final thickness = widget.visible
                    ? (tabIsDragging
                        ? 1.0
                        : (alignmentDelta / 0.32).clamp(0.0, 1.0))
                    : 0.0;
            ...
            children: [
              ...
              if (widget.visible && thickness > 0.05)
                AnimatedGlassIndicator(
                  ...
                  backgroundKey: _indicatorRefractionKey,
                ),
