...
class _GlassSearchableBottomBarState extends State<GlassSearchableBottomBar>
  ...
  Widget _buildTabRow({
    ...
    if (selected) {
      ...
      // Render all tabs in the selected layer; JellyClipper shows only icons
      // under the moving pill (avoids an empty lens on long tab jumps).
      const aStart = 0;
      final aEnd = widget.tabs.length - 1;
